...
var rootCmd = &cobra.Command{
	Use:   "mazeCli",
	Short: "A simple maze generator.",
	Long: `A maze generator which works by first generating
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.mazeCli.yaml)")
